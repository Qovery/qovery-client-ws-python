...
from qovery-ws.models.environment_status_dto import EnvironmentStatusDto  # noqa: E501
...
class TestEnvironmentStatusDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnvironmentStatusDto:
        """Test EnvironmentStatusDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentStatusDto`
        """
