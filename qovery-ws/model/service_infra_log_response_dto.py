...
class ServiceInfraLogResponseDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, message, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, message, *args, **kwargs):  # noqa: E501
        """ServiceInfraLogResponseDto - a model defined in OpenAPI
