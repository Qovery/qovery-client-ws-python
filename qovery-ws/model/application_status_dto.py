...
class ApplicationStatusDto(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'certificates': ([CertificateStatusDto],),  # noqa: E501
            'id': (str,),  # noqa: E501
            'pods': ([PodStatusDto],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, certificates, id, pods, state, *args, **kwargs):  # noqa: E501
        """ApplicationStatusDto - a model defined in OpenAPI

        Args:
            certificates ([CertificateStatusDto]):
            id (str):
            pods ([PodStatusDto]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, certificates, id, pods, state, *args, **kwargs):  # noqa: E501
        """ApplicationStatusDto - a model defined in OpenAPI
