...
class ServiceLogResponseDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, container_name, created_at, message, pod_name, version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, container_name, created_at, message, pod_name, version, *args, **kwargs):  # noqa: E501
        """ServiceLogResponseDto - a model defined in OpenAPI
