...
class ServiceLogResponseDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message, pod_name, version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            created_at (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, message, pod_name, version, *args, **kwargs):  # noqa: E501
        """ServiceLogResponseDto - a model defined in OpenAPI
