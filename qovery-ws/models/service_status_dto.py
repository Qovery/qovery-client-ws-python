...
class ServiceStatusDto(BaseModel):
    ...
    ServiceStatusDto
    """
    environments: conlist(EnvironmentStatusDto) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceStatusDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceStatusDto:
        """Create an instance of ServiceStatusDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceStatusDto.parse_obj(obj)

        _obj = ServiceStatusDto.parse_obj({
            "environments": [EnvironmentStatusDto.from_dict(_item) for _item in obj.get("environments")] if obj.get("environments") is not None else None
        })
