...
class PodStatusDto(BaseModel):
    ...
    PodStatusDto
    """ # noqa: E501
    containers: List[ContainerStatusDto]
    name: StrictStr
    ...
    state_message: StrictStr
    state_reason: StrictStr
    __properties: ClassVar[List[str]] = ["containers", "name", "restart_count", "service_version", "started_at", "state", "state_message", "state_reason"]
